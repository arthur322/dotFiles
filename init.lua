...
vim.keymap.set('n', '<C-J>', '2<C-e>', { silent = true, noremap = true })
vim.keymap.set('n', '<C-K>', '2<C-y>', { silent = true, noremap = true })
-- Remove ctrlz's suspend
vim.keymap.set('n', '<C-z>', "<Esc>", { silent = true })
...
vim.keymap.set('n', '<leader><tab>', '<C-^>', { desc = '[<Tab>] Last Buffer' })
-- Buffer line
...
local on_attach = function(client, bufnr)
  ...
  nmap('<leader>ss', vim.lsp.buf.signature_help, '[S]ignature Help[s]')
...
-- [[ Configure Harpoon ]]
vim.keymap.set('n', '<leader>gh', require("harpoon.ui").toggle_quick_menu, { desc = '[G]o to [H]arpoon' })
vim.keymap.set('n', '<leader>bh', require("harpoon.mark").add_file, { desc = 'Add [B]uffer to [H]arpoon' })
...
-- # TODOs --
-- - eslint
-- - navigate between telescope search history
-- - file tree
-- - my custom keybindings (scroll, etc...)
-- - treesitter hover
